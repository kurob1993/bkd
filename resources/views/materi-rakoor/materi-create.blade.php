                ...
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ route('materi.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="judul" value="{{ old('judul') }}" class="form-control" id="judul" placeholder="Judul">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="no_dokumen" value="{{ old('no_dokumen') }}" class="form-control" id="noDokumen" placeholder="No Dokumen" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="jam_mulai" value="{{ old('jam_mulai') }}" class="form-control" id="jamMasuk" required>
                            </div>
                            <div class="col-sm-1 text-center">s.d</div>
                            <div class="col-sm-5">
                                <input type="text" name="jam_keluar" value="{{ old('jam_keluar') }}" class="form-control" id="jamKeluar" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="presenter" class="col-sm-2 col-form-label">Presentasi oleh : </label>
                            <div class="col-sm-10">
                            <input type="text" name="presenter" value="{{ old('presenter') }}" class="form-control" id="presenter" placeholder="Presentasi oleh">
                            </div>
                        </div>
                        <div class="form-group row">
