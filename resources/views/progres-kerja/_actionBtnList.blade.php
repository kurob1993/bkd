...
<button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-delete{{$id}}">
    ...
    <div class="modal-dialog modal-sm ">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Hapus {!! $proker !!} ?</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('progres-kerja.destroy',$id) }}" method="post" class="d-flex justify-content-center">
                    {{ method_field('DELETE') }}
                    @csrf
